      ...
      <Container size="wide" className="relative z-10 w-full pb-14 pt-32 sm:pb-18 sm:pt-36 lg:pb-24 lg:pt-40">
        <div className="max-w-[min(42rem,100%)]">
          ...
          <AnimatedSection delay={0.06}>
            <h1 className="max-w-[14ch] font-display text-[clamp(2.45rem,9vw,4rem)] font-medium leading-[1.02] text-white text-balance sm:text-[clamp(3.15rem,5.8vw,4.35rem)] sm:leading-[0.99] lg:text-[clamp(3.75rem,5.5vw,5rem)] lg:leading-[0.95]">
              {hero.title[locale]}
            </h1>
          </AnimatedSection>

          <AnimatedSection delay={0.12}>
            <p className="mt-6 max-w-2xl text-[0.98rem] leading-relaxed text-white/88 sm:text-base lg:text-[1.08rem]">
              {hero.description[locale]}
            </p>
          </AnimatedSection>

          <AnimatedSection delay={0.18}>
            <p className="mt-5 max-w-2xl text-[0.92rem] leading-relaxed text-white/72 sm:text-[0.98rem] lg:text-[1rem]">
